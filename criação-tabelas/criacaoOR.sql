...
--CREATE TABLE tb_Pet OF tp_Pet (Nome PRIMARY KEY); -- TALVEZ PRECISE ADICIONAR CPF DO CLIENTE COMO CHAVE
CREATE TABLE tb_Servico OF tp_Servico (Tipo_Servico PRIMARY KEY);
CREATE TABLE tb_Produto OF tp_Produto (Codigo PRIMARY KEY);
--CREATE TABLE tb_Consulta OF tp_Consulta (Data_Consulta PRIMARY KEY); -- TALVEZ MUDE AINDA ESSA CHAVE
